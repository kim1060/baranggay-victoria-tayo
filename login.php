                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form method="post" autocomplete="off">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <h5 class="text-center" style="letter-spacing: 1px;">Sign
      ...
      echo $_SESSION['UserID'];
        ...
        <script type="text/javascript">
         swal({
            ...
            text: "Please check your username and password or your account is not yet verified.\r\n If you have done register, please check your email for verification code and verify your account.",
            type: "warning",
