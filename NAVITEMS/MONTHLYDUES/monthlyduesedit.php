        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4">
                ...
                <div class="form-floating mb-2 text-start">
                    <input type="file" value="<?php echo $Filename ?>" id="image-input" name="image" accept="image/*"
                        onchange="previewImage()" required />
                </div>

                <div class="form-floating mb-2 text-start">
                    <input type="text" class="form-control" value="<?php echo $Fullname?>" name="Fullname"
                        id="floatingInput" placeholder="Fullname" required>
                    <label for="floatingInput">Fullname</label>
                </div>
                <div class="form-floating mb-2 text-start">
                    <input type="text" class="form-control" value="<?php echo $Position?>" name="Position"
                        id="floatingInput" placeholder="Position" required>
