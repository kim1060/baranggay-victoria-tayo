...
<div class="container">
    <h4 class="mt-3"><span class="bi-cash-stack"></span>
        <?php echo $title ?></h4>
    <hr>
    <div class="rowmb-2">
        <div class="col-md-2">
            <a href="index.php?view=monthlyduesadd" class="btn btn-sm btn-outline-success"><i
            ...
            <div class="col-md-12">
                <div class="card-body">
                    ...
                    <a title="Delete" data-id="<?php echo $row['ID'] ?>" data-bs-toggle="modal"
                        data-bs-target="#delete_monthlydues" class="btn btn-sm btn-outline-danger passID"><i
                            class="bi-trash"></i></a>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="delete_monthlydues" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
if(isset($_POST["btnSubmit"]))
{
    ...
    swal({
        ...
        window.location.href = "index.php?view=monthlydueslist";
    });
    </script>';
}
?>
