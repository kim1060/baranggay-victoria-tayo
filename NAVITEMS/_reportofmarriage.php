        ...
        <div class="row mt-3">
            ...
            <div class="col-md-8">
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>1. Original and photocopy of PSA-issued Birth Certificate.</p>
                    </strong>
                    <input type="file" name="file1" id="file1" required>
                </div>
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>2. Original and photocopy of PSA-issued Certificate of no Marriage (CENOMAR).
                        </p>
                    </strong>
                ...
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>3. Passport copy of each party (data page only).
                        </p>
                    </strong>
                ...
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>4. Two pieces of (preferably 2x2 size) photo for each party.
                        </p>
                    </strong>
...
function file1(){
    $target_dir = "FILE_REPORTOFMARRIAGE/";
...
if(isset($_POST["btnSubmit"]))
{
    ...
    $mail->isHTML(true);
    $mail->Subject='SYSTEM NOTIFICATION: REOPORT OF MARRIAGE';
