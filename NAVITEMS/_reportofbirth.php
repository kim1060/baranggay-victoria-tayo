        ...
        <div class="row mt-3">
            ...
            <div class="col-md-8">
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>1. Accomplished Report of Birth Form (4 copies, all original signed).</p>
                    </strong>
                    <input type="file" name="file1" id="file1" required>
                </div>
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>2. Original and 4 Photocopies of BIRTH CERTIFICATE from hospital.
                        </p>
                    </strong>
                ...
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>3. Original and 4 photocopies of MARRIAGE CONTRACT OF PARENTS (PSA-issued Marriage Contract).
                        </p>
                    </strong>
                ...
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>4. Original and 4 photocopies of PASSPORT OF PARENTS (data page only).
                        </p>
                    </strong>
...
if(isset($_POST["btnSubmit"]))
{
    ...
    $mail->isHTML(true);
    $mail->Subject='SYSTEM NOTIFICATION: REPORT OF BIRTH';
