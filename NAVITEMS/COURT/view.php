...
<div class="container mb-4">
    <form method="post">
        ...
        <br>
        <strong>Time:</strong>
        <?php echo date('h:i A', strtotime($FromTime)). ' to ' .date('h:i A', strtotime($ToTime))?>
        <hr>
        ...
        <div class="row g-1 mb-4 text-center">
            <div class="col-12">
                ...
                <?php }?>
                <a href="index.php?view=courtlist"><button type="button" class="btn btn-outline-danger btn-sm"><span
                            class="bi-arrow-left"></span> Back</button></a>
                <?php
                }else{
                ?>
                <a href="index.php?view=mycedulalist"><button type="button" class="btn btn-outline-danger btn-sm"><span
                            class="bi-arrow-left"></span> Back</button></a>
                <?php }?>
            </div>
        </div>
...
if(isset($_POST["btnSubmit"]))
{
        ...
        swal({
            ...
            window.location.href = "index.php?view=courtlist";
        });
        </script>';
