<div class="container">
    ...
    <div class="row">
        <div class="table-responsive">
            <table id="indigency-list-table" class="table table-bordered table-sm table-hover datatable-auto">
                ...
                <tbody>
					...
					foreach ($cur as $result) {
                        ...
                        <a href="index.php?view=indigencyview&id='.$result->ID.'" class="btn btn-sm btn-outline-primary"><span class="bi-eye"> VIEW DETAILS</span></a>
                         </td>';
						echo '</tr>';
					}
					?>
