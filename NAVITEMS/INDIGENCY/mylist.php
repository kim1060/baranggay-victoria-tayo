...
<div class="container">
    ...
    <div class="row">
        <div class="table-responsive">
            <table id="indigency-mylist-table" class="table table-bordered table-sm table-hover datatable-auto">
                ...
                <tbody>
					...
					foreach ($cur as $result) {
                        ...
                        {
                            echo '<td class="text-center">
                            <a href="index.php?view=paymentindigency&id='.$result->ID.'" target="_blank" class="btn btn-sm btn-outline-success"><span class="bi-credit-card"> PROCEED TO PAYMENT</span></a>
                            </td>';
                        }
                        elseif($result->Status=='CONFIRMED' && $result->ApprovedDate!=NULL)
                        {
                            ...
                            <a href="check_indigency_payment_status.php?id='.$result->ID.'" target="_blank" class="btn btn-sm btn-primary mt-2">
