        ...
        <div class="row mt-3">
            ...
            <div class="col-md-8">
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>1. Original and photocopy of document for Authentication with seal and signature of
                            authenticating officer at the Saudi Ministry of Foreign Affairs.</p>
                    </strong>
                    <input type="file" name="file1" id="file1" required>
                </div>
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>2. Two (2) photocopies of valid passport.
                        </p>
                    </strong>
...
function file1(){
    $target_dir = "FILE_NOTARIALSERVICE/";
...
if(isset($_POST["btnSubmit"]))
{
    ...
    $mail->isHTML(true);
    $mail->Subject='SYSTEM NOTIFICATION: NOTARIAL SERVICE';
