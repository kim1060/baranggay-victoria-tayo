            ...
            <table id="example" class="table table-bordered table-sm table-hover">
                ...
                <tbody>
					...
					foreach ($cur as $result) {
                            ...
                            echo '<td>'.$result->FirstTimeJob.'</td>';
                        ...
                        <a href="index.php?view=clearanceview&id='.$result->ID.'" class="btn btn-sm btn-outline-primary"><span class="bi-eye"> VIEW DETAILS</span></a>
                         </td>';
						echo '</tr>';
					}
					?>
