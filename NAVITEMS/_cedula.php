...
if(isset($_POST["btnModalSubmit"]))
{
    ...
    if ($existingAppointment && isset($existingAppointment->ID)) {
        ...
        swal({
            ...
            text: "You have a pending cedula appointment on ' . $existingDate . '. Please wait for it to be processed or let the appointment date pass before booking a new one.",
            type: "warning",
