        ...
        <div class="row mt-3">
            ...
            <div class="col-md-8">
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>1. Police Clearance Endorsement.</p>
                    </strong>
                    <input type="file" name="file1" id="file1" required>
                </div>
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>2. Photocopy of valid passport.
                        </p>
                    </strong>
                ...
                <div class="form-floating mb-2 text-start">
                    <strong>
                        <p>3. Photocopy of Iqama/ Residence Permit.
                        </p>
                    </strong>
...
if(isset($_POST["btnSubmit"]))
{
    ...
    $mail->isHTML(true);
    $mail->Subject='SYSTEM NOTIFICATION: OTHER SERVICES';
