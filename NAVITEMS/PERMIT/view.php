    ...
    <form method="post">
        ...
        <div class="row g-1 mb-4 text-center">
            <div class="col-12">
                ...
                <?php }?>
                <a href="index.php?view=permitlist"><button type="button" class="btn btn-outline-danger btn-sm"><span
                            class="bi-arrow-left"></span> Back</button></a>
                <?php
                }else{
                ?>
                <a href="index.php?view=mypermitlist"><button type="button" class="btn btn-outline-danger btn-sm"><span
                            class="bi-arrow-left"></span> Back</button></a>
                <?php }?>
            </div>
        </div>
    </form>
    <form method="POST" action="printpermit.php" target="_blank">
...
if(isset($_POST["btnSubmit"]))
{
        ...
        $mail->isHTML(true);
        $mail->Subject='SYSTEM NOTIFICATION: BUSINESS PERMIT';
        ...
        swal({
            ...
            window.location.href = "index.php?view=permitlist";
        });
        </script>';
